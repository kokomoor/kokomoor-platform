...
class CaptchaHandler:
    ...
    async def handle(
        ...
        *,
        ...
        # Tier 1: wait and re-detect (Cloudflare JS challenges often self-resolve)
    ...
    # ------------------------------------------------------------------
    # Private: 2captcha reCAPTCHA v2 solver
    # ------------------------------------------------------------------
    ...
    async def _solve_recaptcha_v2(
        ...
        *,
        ...
        try:
            import httpx  # 2captcha solver API — external service, not a job board fetch
        except ImportError:
            return CaptchaOutcome(
                resolved=False,
                strategy_used="unsolvable",
